...
const (
	...
	HabitService_GetHabits_FullMethodName   = "/habit.HabitService/GetHabits"
	HabitService_UpdateHabit_FullMethodName = "/habit.HabitService/UpdateHabit"
...
func (c *habitServiceClient) GetHabits(ctx context.Context, in *GetHabitsRequest, opts ...grpc.CallOption) (*GetHabitsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedHabitServiceServer) GetHabits(context.Context, *GetHabitsRequest) (*GetHabitsResponse, error) {
...
var HabitService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "habit-service/proto/habit-service.proto",
}
